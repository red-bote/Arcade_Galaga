...
#
# The .xpr references mist/scandoubler.v directly ($PPRDIR/../mist/scandoubler.v),
# which was patched in-place by make setup (contrib/code/scandoubler_fix.patch).
...
step "2/3 Copying arcade_galaga_basys3.xpr"
