#!/bin/bash
# Generate the clk_wiz_0 MMCM IP (100 MHz -> 36 MHz core/scandoubler clock)
# for the Basys3 port and place its Verilog wrappers where
# arcade_galaga_basys3.xpr expects them.
#
...
CLK_WIZ_IMPORT_DIR="$XPR_DIR/arcade_galaga_basys3.srcs/sources_1/imports/clk_wiz_0"
